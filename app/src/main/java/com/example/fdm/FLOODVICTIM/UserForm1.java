...
public class UserForm1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userform1);

        phone = findViewById(R.id.phone1);
        age = findViewById(R.id.age1);
        occupation = findViewById(R.id.occupation1);
        income = findViewById(R.id.income1);
        address1 = findViewById(R.id.addressa1);
        address2 = findViewById(R.id.addressb1);
        male = findViewById(R.id.gendermale1);
        female = findViewById(R.id.genderfemale1);
        unext1 = findViewById(R.id.unext1);
        ...
        unext1.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void onClickedNext() {
        ...
        if (TextUtils.isEmpty(mPhoneString)) {
            Toast.makeText(UserForm1.this, "Enter the phone number", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(mAgeString)) {
            Toast.makeText(UserForm1.this, "Enter the age", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(mOccupationString)) {
            Toast.makeText(UserForm1.this, "Enter the occupation", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(mIncomeString)) {
            Toast.makeText(UserForm1.this, "Enter the income", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(mAddress1String)) {
            Toast.makeText(UserForm1.this, "Enter the address", Toast.LENGTH_SHORT).show();
...
//Store userdetail in firebase.
    ...
    private void addDataToFirestore() {
        ...
        Intent intent = new Intent(UserForm1.this, HouseholdForm1.class);
        Bundle b = new Bundle();
        b.putSerializable(getString(R.string.key_flood_victim_form1),floodVictimEntity);
    ...
    private void getListItems() {
        ...
        DocumentReference documentReferenceFV = fstore.collection("floodVictimDetail(HealthAids)").document(userID);
