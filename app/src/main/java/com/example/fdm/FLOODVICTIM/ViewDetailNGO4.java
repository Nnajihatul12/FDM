...
public class ViewDetailNGO4 extends AppCompatActivity {
    Button form4;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_viewdetailngo4);
    ...
    private void onClickedForm4() {
        Intent i = new Intent(ViewDetailNGO4.this, UserForm4.class);
        startActivity(i);
    }
}
