...
public class UserForm2 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userform2);

        phone = findViewById(R.id.phone2);
        age = findViewById(R.id.age2);
        occupation = findViewById(R.id.occupation2);
        income = findViewById(R.id.income2);
        address1 = findViewById(R.id.addressa2);
        address2 = findViewById(R.id.addressb2);
        male = findViewById(R.id.gendermale2);
        female = findViewById(R.id.genderfemale2);
        unext2 = findViewById(R.id.unext2);
        ...
        unext2.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void onClickedNext() {
        ...
        if (TextUtils.isEmpty(mPhoneString)){
            Toast.makeText(UserForm2.this,"Enter the phone number", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(mAgeString)){
            Toast.makeText(UserForm2.this,"Enter the age", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(mOccupationString)){
            Toast.makeText(UserForm2.this,"Enter the occupation", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(mIncomeString)){
            Toast.makeText(UserForm2.this, "Enter the income", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(mAddress1String)){
            Toast.makeText(UserForm2.this, "Enter the address", Toast.LENGTH_SHORT).show();
    ...
    private void addDataToFirestore() {
        ...
        Intent intent = new Intent(UserForm2.this, HouseholdForm2.class);
        Bundle b = new Bundle();
        b.putSerializable(getString(R.string.key_flood_victim_form2),floodVictimEntity);
    ...
    private void getListItems() {
        ...
        DocumentReference documentReferenceFV = fstore.collection("floodVictimDetail(MonetaryAids)").document(userID);
